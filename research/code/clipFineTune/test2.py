...
fromPILimportImage
importopen_clip
device=torch.device("cuda:x"iftorch.cuda.is_available()else"cpu")
...
text=tokenizer(["aHug","theEsha","theAnjali"])#.cuda(device=device)

withtorch.no_grad(),torch.cpu.amp.autocast():
...
print("Labelprobs:",text_probs)#prints:[[1.,0.,0.]]
