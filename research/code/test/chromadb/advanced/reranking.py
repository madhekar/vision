...
client, image_collection, _,_ = init_vdb()
...
results = collection.query(
    ...
    n_results=10 # Retrieve more than you need, to be narrowed down by the reranker
)
...
pairs = [[query_text, meta['description']] for meta in candidate_images]
