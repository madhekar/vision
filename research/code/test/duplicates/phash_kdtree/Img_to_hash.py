...
hash_algo_dict = {'average_hash': imagehash.average_hash, 
...
class ImageToHash(object):
    ...
    def __init__(self, images_path, hash_size=8, hash_algo='phash', verbose=0):
        ...
        self.img_file_list = ImageToHash.get_images_list(images_path, natural_order=True)
    ...
    def build_hash_to_image_dataframe(self):
        ...
        for image in tqdm(self.img_file_list):
            ...
            if hash_code in dict_hash_to_images:
                if self.verbose == 2:
                    print(image, '  already exists in', ' '.join(dict_hash_to_images[hash_code]))
