...
slide = open_slide("../images/kidney.svs")
...
print("*** How many tiles at specific level ***")
level_num = 11
...
tile_dims = tiles.get_tile_dimensions(11, (2,2)) #Provide deep zoom level and address (column, row)
...
print("*** tile count in lerge image: " + str(tile_count_in_large_image))
#Check tile size for some random tile
tile_dims = tiles.get_tile_dimensions(16, (120,80))
#Last tiles may not have full 256x256 dimensions as our large image is not exactly divisible by 256
tile_dims = tiles.get_tile_dimensions(16, (128,89))
